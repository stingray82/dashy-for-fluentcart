...
# =====================================================
HEADER_SCRIPT="${HEADER_SCRIPT:-C:\Ignore By Avast\0. PATHED Items\Plugins\deployscripts/myplugin_headers_rup_gpl3.0.php}"
...
echo "$config_file"
echo
echo "[DEBUG] HEADER_SCRIPT:"
echo "$HEADER_SCRIPT"
echo
echo "[DEBUG] PLUGIN FILE:"
echo "$plugin_file"
echo "========================================"
